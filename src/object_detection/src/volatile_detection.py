...
class ObjectDetection(object):
	...
	def __init__(self):
		...
		self.simple_blob_detector_params.maxThreshold = 255          # default = 255

		# filter by area
		self.simple_blob_detector_params.filterByArea = True          # default = True
		self.simple_blob_detector_params.minArea = 100
		self.simple_blob_detector_params.maxArea = 1000
		               # default = 1
